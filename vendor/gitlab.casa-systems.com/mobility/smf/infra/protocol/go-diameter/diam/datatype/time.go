...
// TimeType should support msgpack marshal
func (t Time) EncodeMsgpack(e *msgpack.Encoder) error {
	return e.EncodeMulti((time.Time)(t))
}

// TimeType should support msgpack unmarshal
func (t *Time) DecodeMsgpack(d *msgpack.Decoder) error {
	return d.DecodeMulti((*time.Time)(t))
}
